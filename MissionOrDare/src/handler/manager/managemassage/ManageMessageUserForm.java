...
@Controller
public class ManageMessageUserForm implements CommandHandler {
	@Resource
	ManageUserDao manageUserDao;
	
	@RequestMapping("/manage_message_user_form")
	@Override
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		return new ModelAndView("manager/pages/manage_message_user_form");
	}
}
