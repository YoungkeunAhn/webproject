...
<div class="container">
    <article>
        <section class="mission-info-view">
            ...
            <img src="../images/mission_image.png" alt="mission-image">
            <ul>
                <li>미션 성공 조건</li>
            ...
            <div class="btn-line">
                ...
                <button type="button" class="btn btn-danger" onclick="location.href='user_missionGetPro?mission_level=1&mission_challenge=1'">다시받기</button>
            </div>
        </section>
    </article>
</div>
