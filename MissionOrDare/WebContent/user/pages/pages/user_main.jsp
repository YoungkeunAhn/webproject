            ...
            <section class="mission-list">
                ...
                <ol class="date-exist">
                    ...
                    <form name="myMissionAuthForm" action="user_myMissionAuth.jsp">
                   	 	...
                   	 	<input type="text" value="라이언 이모티콘을 따라 그려봅시다">
                   	 	<input type="text" value="진행중">
                        <li class="text-date"><span>2020.07.06 13:43 시작</span></li>
                        <li class="text-category"><span>운동/헬스</span></li>
                        <li class="text-mission"><span>라이언이 부탁한 자화상</span></li>
                        <li><img src="../images/mission_img1.png" alt="mission-image"></li>
                        <li class="text-summary"><span>라이언 이모티콘을 따라 그려봅시다</span></li>
                        <li class="text-status"><span>진행중</span></li>
