	...
	<div class="container">
		<header>
			...
			<div id="menu_list" class="menu_list">
				<span onclick="GoMainPage()">Logout</span> <br> <br> <span>Withdrawal</span>
			</div>
			...
			<div class="white-box">
				<section class="imymemine">
					<div class="content-profile">
						<img onclick="MyProfileModify()" class="img-circle"
							src="${userDto.profile_picture}" alt="user-profile"> <span>${userDto.user_nickname}</span>
					</div>
					<img onclick="GoMessageForm()" src="${project}images/message12.png"
						alt="user-message">
					<div class="write-control">
						<span>관심분야: ${userDto.interesting1_large_category}
							${userDto.interesting2_large_category}
							${userDto.interesting3_large_category}
							${userDto.interesting4_large_category}</span>
					</div>
					<div class="write-control">가입일: ${userDto.sign_up_date}</div>
					<div class="aho">
						<button class="gaein" type="submit" onclick="MyInfoModify()">
							<span>개인정보수정</span>
						</button>
					</div>
				</section>
				...
				<div class="white-box1">
					...
					<div class="myMissionpackage">
						<c:forEach var="userMissionDto" items="${userMissionDtos}">
							...
							<div class="gay">
								<span>${userMissionDto.mission_start_date}</span>
							</div>
							<div class="good">
								<img class="missionimage" src="/upload/${userMissionDto.upload_image}"
									alt="mission-image1"> <span>${userMissionDto.mission_title}</span> <span> 
