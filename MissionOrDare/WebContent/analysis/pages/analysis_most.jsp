...
<body id="test">
	...
	<svg  id="GoTop" onclick="fnMove('1')" class="starStick" id="svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="padding:10px; position: fixed; right:0%; height: 70px; width:86px; z-index:1000;">
			<path class="star"
