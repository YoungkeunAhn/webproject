  			...
  			<div class="likeSubContentDiv">
  				<div class="ranking-searchArea">
  					<div class="BoardArea">
  						...
  						<span>MissionOrDare 조회수 랭킹!</span>
  						검색하세요
  						</p>
	  							...
	  							<tr>
	  								...
	  								<td style="width:16%;">
	  									<div class="ProfileArea">
	  										<img class="analysis_RankingBoardImage" src="/upload/${usersDto.profile_picture}" alt="roses_are_rosie 프로필 이미지">
	  										<div style="display:flex; flex-wrap:wrap;">
	  											<div class="userNickname">${usersDto.user_nickname}</div>
